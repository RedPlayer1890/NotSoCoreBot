...
module.exports = async function (interaction) {
    ...
    const Cuentas = guild.channels.cache.find(c => c.name === TConfig.categories.TicketsCuentas.name && c.type === 'GUILD_CATEGORY');
    ...
    channel.send({
        ...
        channel.awaitMessages({
            ...
            let pregunta2 = new MessageEmbed()
                .setColor('#0099ff')
                .setDescription(_ticketsQuestions.TicketsCuentas.segunda);
            channel.send({
                embeds: [pregunta2]
            });
            channel.awaitMessages({
                ...
                let pregunta3 = new MessageEmbed()
                    .setColor('#0099ff')
                    .setDescription(_ticketsQuestions.TicketsCuentas.tercera);
                channel.send({
                    embeds: [pregunta3]
                });
                channel.awaitMessages({
                    ...
                    let pregunta4 = new MessageEmbed()
                        .setColor('#0099ff')
                        .setDescription(_ticketsQuestions.TicketsCuentas.cuarta);
                    channel.send({
                        embeds: [pregunta4]
                    });
                    channel.awaitMessages({
                        ...
                        let pregunta5 = new MessageEmbed()
                            .setColor('#0099ff')
                            .setDescription(_ticketsQuestions.TicketsCuentas.quinta);
                        channel.send({
                            embeds: [pregunta5]
                        });
                        channel.awaitMessages({
